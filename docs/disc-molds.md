...
| Distance driver | Beat-in Destroyer-like character: high-speed, understable-to-flat hyzer-flip and a fast, laser-like line | Remains a physical projectile | Valid release envelope, target coefficients, and speed tuning are **TBD** |
